    ...
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-base text-gray-400 tracking-wide">
          I'm excited to bring dedication and creativity to your next project.
          Let's connect — I'm just a message away!
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Phone: <span className="text-lightText">+91 7903246497</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className="text-lightText">sumitkumar67670@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
